...
class InfoViewController: UIViewController {
    ...
    i.numberOfLines = 5
    i.text = "My favourite weather app is an app that gets wheather information by city name. The API is from APIXU, it can be configured to be viewed in current or forecast, the app is operating under current mode"
