...
class ViewByLocationController: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate {
    ...
    func setup(){
        ...
        UIImage(named: "Cherry")?.draw(in: self.view.bounds)
        ...
        press.bottomAnchor.constraint(equalTo: bottomLine.topAnchor, constant: -5).isActive = true
        ...
        rainy.bottomAnchor.constraint(equalTo: bottomLine.topAnchor, constant: -5).isActive = true
